...
private:
    ...
    SwerveModule m_moduleFR{frDM, frTM, frENC, "FR", frOffset, 0.069, 0, 0};
    SwerveModule m_moduleBR{brDM, brTM, brENC, "BR", brOffset, 0.069, 0, 0};
    SwerveModule m_moduleFL{flDM, flTM, flENC, "FL", flOffset, 0.069, 0, 0};
    SwerveModule m_moduleBL{blDM, blTM, blENC, "BL", blOffset, 0.05, 0, 0};
